...
export default function Eventos() {
    return (
        <div className='bg-gradient-to-b from-[#B2DEE1] to-[#fff] py-10'>
                        ...
                        <div className='p-8 bg-[#0871B538] rounded-lg flex flex-col justify-center h-full'>
                            ...
                            <motion.ul
                                ...
                                <motion.li
                                    ...
                                    <span>Organização de seminários e workshops</span>
                                </motion.li>
                                <motion.li
                                    whileHover={{ x: 5 }}
                                    className='flex items-start'>
                                    <span className='inline-block w-2 h-2 bg-[#0871B5] rounded-full mt-2 mr-2'></span>
                                    <span>Logística para conferências e feiras</span>
                                </motion.li>
                                <motion.li
                                    whileHover={{ x: 5 }}
                                    className='flex items-start'>
                                ...
                                <motion.li
                                    ...
                                    className='flex items-start'>
                                    <span className='inline-block w-2 h-2 bg-[#0871B5] rounded-full mt-2 mr-2'></span>
                                    <span>Programas de incentivo para colaboradores</span>
                                </motion.li>
                            </motion.ul>
